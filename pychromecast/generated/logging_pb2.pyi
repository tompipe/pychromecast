...
class ChallengeReplyErrorType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    CHALLENGE_REPLY_ERROR_CERT_NOT_SIGNED_BY_TRUSTED_CA: _ClassVar[
    ...
    CHALLENGE_REPLY_ERROR_TLS_CERT_VALIDITY_PERIOD_TOO_LONG: _ClassVar[
        ChallengeReplyErrorType
    ]
    CHALLENGE_REPLY_ERROR_TLS_CERT_VALID_START_DATE_IN_FUTURE: _ClassVar[
        ChallengeReplyErrorType
    ]
...
class SocketEvent(_message.Message):
    ...
    def __init__(
        ...
        challenge_reply_error_type: _Optional[
            _Union[ChallengeReplyErrorType, str]
        ] = ...,
...
class Log(_message.Message):
    ...
    aggregated_socket_event: _containers.RepeatedCompositeFieldContainer[
    ...
    def __init__(
        self,
        aggregated_socket_event: _Optional[
            _Iterable[_Union[AggregatedSocketEvent, _Mapping]]
        ] = ...,
